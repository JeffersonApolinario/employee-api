...
## Observações
Este projeto esta usando o SQLite caso você configurar outro banco vá na pasta employee_manager e altere o arquivo settings.py
...
Neste projeto utilizei o venv como para o ambiente virtual, caso esteja utilizando outro configure do seu modo.
...
## Uso
Para subir a app basta digitar este comando
```
